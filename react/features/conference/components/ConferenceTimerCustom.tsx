...
/**
 * The type of the React {@code Component} props of {@link ConferenceTimerCustom}.
 */
interface IProps {
...
const ConferenceTimerCustom = ({ textStyle }: IProps) => {
    ...
    return (<div className='conference-custom__timer'><span>{ timerValue }</span></div>);
};

export default ConferenceTimerCustom;
