...
const COMPONENTS: Array<{
    ...
    {
        Component: ConferenceTimerCustom,
        id: 'conference-timer'
    },
    {
        Component: () => (
            <>
                <RecordingLabelCustom mode = { JitsiRecordingConstants.mode.FILE } />
                <RecordingLabelCustom mode = { JitsiRecordingConstants.mode.STREAM } />
            </>
        ),
        id: 'recording'
    },
 ...
 * @returns {React$None}
 */
class ConferenceInfoCustom extends Component<IProps> {
    /**
...
export default connect(_mapStateToProps)(ConferenceInfoCustom);
