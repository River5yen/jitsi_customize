 ...
 * @augments {Component}
 */
class RecordingLabelCustom extends AbstractRecordingLabel<IProps> {
    /**
...
export default withStyles(translate(connect(_mapStateToProps)(RecordingLabelCustom)), styles);
